...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.state_control = ttk.Frame(self.tab_control)
        ...
        self.tab_control.add(self.state_control, text='State Machine Control')
        ...
        # Button for State Machine to retrieve the tool
        self.state_retrieve = tk.Button(self.state_control,
                text='State Retrieval', fg='blue',
                command=self.tool_retrieve, font='Courier 20 bold')
        self.state_retrieve.grid(row=0, column=0,
                sticky=tk.NSEW, pady=5, padx=2)

        # Button for State Machine to stow the tool
        self.state_stow = tk.Button(self.state_control,
                text='State Stowage', fg='blue',
                command=self.tool_stow, font='Courier 20 bold')
        self.state_stow.grid(row=0, column=1,
                sticky=tk.NSEW, pady=5, padx=2)
    ...
    def tool_stow(self):
        time.sleep(delay_len)
        os.system('rosrun behavior_algorithms stowage_state_machine')
        time.sleep(delay_len)

    def tool_retrieve(self):
        time.sleep(delay_len)
        os.system('rosrun behavior_algorithms retrieval_state_machine')
        time.sleep(delay_len)
