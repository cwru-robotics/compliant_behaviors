...
int main(int argc, char** argv) {
    ...
    */
    while(current_loop <= MAX_LOOPS && !effort_limit_crossed && !freeze_mode){ //! Freeze mode check? 
        ...
        // Use sin cos and some angle for rotations, and push down in z
        ...
        virtual_attractor.pose.position.z = current_pose.position.z + MOVE_DISTANCE; // predefined value to push down
