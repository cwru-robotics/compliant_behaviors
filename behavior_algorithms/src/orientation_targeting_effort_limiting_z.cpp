...
int main(int argc, char** argv) {
    ...
    *///                                                    was 15            was  0.1
    double DT = 0.01, TORQUE_THRESHOLD = 0.8, FORCE_THRESHOLD = 17, ROTATE_ANGLE = 0.15, KEEP_CONTACT_ANGLE = 0.1, TARGET_ORIENTATION = 0.05; // Do not increase the virtual attractor angle greater than 1.55 radians
