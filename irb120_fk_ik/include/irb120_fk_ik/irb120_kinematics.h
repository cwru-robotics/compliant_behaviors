...
// const double DH_d6 = 0.072 + 0.08 + 0.1 + 0; // with cyllinder attached
const double DH_d6 = 0.072 + 0.08; // + 0.21 + 0; // with pencil attached was 0.24, then 0.23, with gripper 0.21
